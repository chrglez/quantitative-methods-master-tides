...
::: {.callout-note}
**Main way to sync · the *Sync fork* button on GitHub.** This step
adds an `upstream` reference locally as a backup, in case you ever
need to sync from RStudio instead of the web.
:::
...
and `upstream` (the course repo). Close the terminal — in the daily
flow you sync from the GitHub web button.
